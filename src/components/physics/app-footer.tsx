...
export function AppFooter({
  ...
  if (variant === "full") {
    return (
      <footer
        className="fixed bottom-0 inset-x-0 z-50 backdrop-blur-md bg-black/30 border-t border-white/10 py-2"
  ...
  return (
    <footer
      className="fixed bottom-0 inset-x-0 z-50 backdrop-blur-md bg-black/30 border-t border-white/10 py-1.5"
      style={{ paddingBottom: "env(safe-area-inset-bottom)" }}
    >

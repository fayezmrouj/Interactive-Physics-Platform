...
function MixedText({ text }: { text: string }) {
  ...
  // وتتوقف عند الحرف العربي (إلا الكلمات العربية المدمجة في _{} مثل F_الشد)
  const pattern = /(\([^)]*[=+\-·/√^²³⁴⁵ΔμρλωθπΣ×½][^)]*\)|[A-Za-z½ΔμρλωθπΣμθω][A-Za-z0-9_\^·×÷±≈≠≤≥=+\-/\s²³⁴⁵⁰¹²³⁴⁵⁶⁷⁸⁹√ΔμρλωθπΣ→.()½ρλ\u0600-\u06FF]*[A-Za-z0-9²³⁴⁵)\u0600-\u06FF]|[A-Za-z½μρλθωΣΔ]\s*[=+]\s*[A-Za-z½ρλμθωF].*?(?=\s+[\u0600-\u06FF][\u0600-\u06FF]|$)|\d+\.?\d*\s*[mkgNJPaHzW][/^²³⁴⁵·\d]*\d?)/g;

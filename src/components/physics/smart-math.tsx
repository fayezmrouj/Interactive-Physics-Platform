...
function MixedText({ text }: { text: string }) {
  ...
  // النمط يطابق: أي تسلسلة يحتوي على = أو · أو × أو / أو ^ أو ² ويبدأ بحرف لاتيني أو رقم أو رمز
  // وينتهي قبل الحرف العربي الأول أو نهاية السلسلة
  const pattern = /(\([^)]*[=+\-·/√^²³⁴⁵ΔμρλωθπΣ×½][^)]*\)|[A-Za-z½ΔμρλωθπΣ][A-Za-z0-9_\^·×÷±≈≠≤≥=+\-/\s²³⁴⁵⁰¹²³⁴⁵⁶⁷⁸⁹√ΔμρλωθπΣ→.()½ρλ]*[A-Za-z0-9²³⁴⁵)\]]|[A-Za-z]\s*[=+]\s*[A-Za-z½ρλμθω][^،,.\u0600-\u06FF]*|\d+\.?\d*\s*[mkgNJPaHzW][/^²³⁴⁵·\d]*\d?)/g;
